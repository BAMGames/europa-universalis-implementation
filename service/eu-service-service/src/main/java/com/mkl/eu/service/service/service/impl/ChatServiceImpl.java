...
public class ChatServiceImpl extends AbstractService implements IChatService {
    ...
    public DiffResponse createRoom(Request<CreateRoomRequest> request) throws FunctionalException, TechnicalException {
        ...
        PlayableCountryEntity owner = CommonUtil.findFirst(gameDiffs.getGame().getCountries().stream(),
                c -> c.getId().equals(request.getGame().getIdCountry()));

        failIfNull(new AbstractService.CheckForThrow<>().setTest(owner).setCodeError(IConstantsCommonException.INVALID_PARAMETER)
                .setMsgFormat(MSG_OBJECT_NOT_FOUND).setName(PARAMETER_CREATE_ROOM, PARAMETER_ID_COUNTRY).setParams(METHOD_CREATE_ROOM, request.getGame().getIdCountry()));
    ...
    public DiffResponse speakInRoom(Request<SpeakInRoomRequest> request) throws FunctionalException, TechnicalException {
        ...
        failIfNull(new AbstractService.CheckForThrow<>().setTest(sender).setCodeError(IConstantsCommonException.INVALID_PARAMETER)
                .setMsgFormat(MSG_OBJECT_NOT_FOUND).setName(PARAMETER_SPEAK_IN_ROOM, PARAMETER_ID_COUNTRY).setParams(METHOD_SPEAK_IN_ROOM, request.getGame().getIdCountry()));
    ...
    public DiffResponse toggleRoom(Request<ToggleRoomRequest> request) throws FunctionalException, TechnicalException {
        ...
        failIfNull(new AbstractService.CheckForThrow<>().setTest(sender).setCodeError(IConstantsCommonException.INVALID_PARAMETER)
                .setMsgFormat(MSG_OBJECT_NOT_FOUND).setName(PARAMETER_TOGGLE_ROOM, PARAMETER_ID_COUNTRY).setParams(METHOD_TOGGLE_ROOM, request.getGame().getIdCountry()));
        ...
        PresentEntity present = CommonUtil.findFirst(room.getPresents(), presentEntity -> request.getGame().getIdCountry().equals(presentEntity.getCountry().getId()));
    ...
    public DiffResponse inviteKickRoom(Request<InviteKickRoomRequest> request) throws FunctionalException, TechnicalException {
        ...
        failIfNull(new AbstractService.CheckForThrow<>().setTest(owner).setCodeError(IConstantsCommonException.INVALID_PARAMETER)
                .setMsgFormat(MSG_OBJECT_NOT_FOUND).setName(PARAMETER_INVITE_KICK_ROOM, PARAMETER_ID_COUNTRY).setParams(METHOD_INVITE_KICK_ROOM, request.getGame().getIdCountry()));
    ...
    public DiffResponse readRoom(Request<ReadRoomRequest> request) throws FunctionalException, TechnicalException {
        ...
        failIfNull(new AbstractService.CheckForThrow<>().setTest(owner).setCodeError(IConstantsCommonException.INVALID_PARAMETER)
                .setMsgFormat(MSG_OBJECT_NOT_FOUND).setName(PARAMETER_READ_ROOM, PARAMETER_ID_COUNTRY).setParams(METHOD_READ_ROOM, request.getGame().getIdCountry()));
        ...
        chatDao.readMessagesInRoom(request.getRequest().getIdRoom(), request.getGame().getIdCountry(), request.getRequest().getMaxId());
