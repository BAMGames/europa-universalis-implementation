...
public class TablesDaoImpl extends GenericDaoImpl<TradeIncomeEntity, Long> implements ITablesDao {
    ...
    /** {@inheritDoc} */
    @Override
    public List<AssaultResultEntity> getAssaultResults() {
        Criteria criteria = getSession().createCriteria(AssaultResultEntity.class);
    ...
    /** {@inheritDoc} */
    @Override
    public List<ExchequerEntity> getExchequers() {
        Criteria criteria = getSession().createCriteria(ExchequerEntity.class);
    ...
    /** {@inheritDoc} */
    @Override
    public List<DiscoveryTableEntity> getDiscoveries() {
        Criteria criteria = getSession().createCriteria(DiscoveryTableEntity.class);
    ...
    /** {@inheritDoc} */
    @Override
    public List<AttritionLandEuropeEntity> getAttritionLandEurope() {
        Criteria criteria = getSession().createCriteria(AttritionLandEuropeEntity.class);
    ...
    /** {@inheritDoc} */
    @Override
    public List<AttritionOtherEntity> getAttritionOther() {
        Criteria criteria = getSession().createCriteria(AttritionOtherEntity.class);
